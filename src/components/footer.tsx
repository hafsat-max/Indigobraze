...
export const Footer = () => {
  return (
    <section className="bg-primary">
      <div className="flex w-[88%] mx-auto py-[5rem] justify-between max-[500px]:flex-col  max-[500px]:gap-10">
        {/* left side */}
        <div className="flex flex-col gap-4 text-white">
          ...
          <ul className="flex gap-2 items-center">
            ...
            >
              ...
              <Xrp size="24" color="white" variant="Bold"/>
            </a>
          </ul>
        </div>

        {/* right side */}
        <div className="flex flex-col gap-5 text-white" id="contact">
