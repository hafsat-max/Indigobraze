import { Call, Instagram, Whatsapp, Youtube,Location, Facebook } from 'iconsax-react'
      ...
      >
        ...
        <div className='flex flex-col gap-4 text-white'>
          ...
          <ul className='flex gap-2 items-center'>
            <li><a href='https://www.instagram.com/indigobraze?igsh=MTVmY3dha2VoeDhkbw==' target='_blank'>
              <Instagram size={24} />
            </a>
            </li>
            <li><a href='https://wa.me/+447459619262' target='_blank'>
              <Whatsapp size={24} />
            </a>
            </li>
            <li><a href='https://www.facebook.com/indigobrazetechnologies' target='_blank'>
              <Facebook size={24} />
            </a>
            </li>
            <a href="https://x.com/IndigobrazeT?t=jHOnMoPrsnkhvKb-z9Lk6g&s=09" target='_blank'>
